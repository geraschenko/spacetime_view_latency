...
pub use append_message_reducer::{
    append_message, set_flags_for_append_message, AppendMessageCallbackId,
};
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "append_message" => Ok(__sdk::parse_reducer_args::<
                append_message_reducer::AppendMessageArgs,
            >("append_message", &value.args)?
            .into()),
            unknown => {
                Err(
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.messages_view =
            cache.apply_diff_to_table::<Message>("messages_view", &self.messages_view);
