...
pub mod append_message_reducer;
pub mod message_type;
pub mod messages_table;
pub mod messages_view_table;

pub use append_message_reducer::append_message;
pub use message_type::Message;
pub use messages_table::*;
pub use messages_view_table::*;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::AppendMessage { .. } => "append_message",
            _ => unreachable!(),
        }
    }
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::AppendMessage { content } => {
                __sats::bsatn::to_vec(&append_message_reducer::AppendMessageArgs {
...
pub struct DbUpdate {
    ...
    messages_view: __sdk::TableUpdate<Message>,
}
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                ...
                "messages_view" => db_update
                    .messages_view
                    .append(messages_view_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.messages_view = cache
            .apply_diff_to_table::<Message>("messages_view", &self.messages_view)
            .with_updates_by_pk(|row| &row.id);
...
pub struct AppliedDiff<'r> {
    ...
    messages_view: __sdk::TableAppliedDiff<'r, Message>,
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        messages_view_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["messages", "messages_view"];
}
